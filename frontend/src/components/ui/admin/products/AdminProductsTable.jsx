                  ...
                  <td className="px-4 py-4">
                    <div className="flex min-w-64 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        {product.slug ? (
                          <Link to={`/products/${product.slug}`} className="block max-w-64 truncate font-bold text-slate-900 hover:text-green-700 hover:underline">
                            {highlight(product.name, keyword)}
                          </Link>
                        ) : <p className="max-w-64 truncate font-bold text-slate-900">{highlight(product.name, keyword)}</p>}
