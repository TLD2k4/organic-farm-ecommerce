export const orderStatusConfig = {
  0: { label: "Chờ xử lý", className: "bg-amber-100 text-amber-700" },
  1: { label: "Đang xử lý", className: "bg-blue-100 text-blue-700" },
  2: { label: "Đang giao", className: "bg-indigo-100 text-indigo-700" },
  3: { label: "Đã giao", className: "bg-green-100 text-green-700" },
  4: { label: "Đã hủy", className: "bg-red-100 text-red-700" },
};

export const subOrderStatusConfig = {
  0: { label: "Chờ xử lý", className: "bg-amber-100 text-amber-700" },
  1: { label: "Chuẩn bị hàng", className: "bg-blue-100 text-blue-700" },
  2: { label: "Đang giao", className: "bg-indigo-100 text-indigo-700" },
  3: { label: "Hoàn tất", className: "bg-green-100 text-green-700" },
  4: { label: "Đã hủy", className: "bg-red-100 text-red-700" },
};
